...
namespace Math {
	...
	std::vector<std::vector<float>> Matrix::Add(std::vector<std::vector<float>> mat1, std::vector<std::vector<float>> mat2) {
		if (mat1.size() != mat2.size()) throw new std::invalid_argument("Add: mat1 size is different that mat2 size! mat1:" + std::to_string(mat1.size()) + " , mat2:" + std::to_string(mat2.size()));
		std::vector<std::vector<float>> new_mat = std::vector<std::vector<float>>();
		for (int i = 0; i < mat1.size(); i++) {
			new_mat.push_back(Vector::Add(mat1[i], mat2[i]));
		}
		return new_mat;
	}
	...
	std::vector<std::vector<float>> Matrix::Sub(std::vector<std::vector<float>> mat1, std::vector<std::vector<float>> mat2) {
		if (mat1.size() != mat2.size()) throw new std::invalid_argument("Sub: mat1 size is different that mat2 size! mat1:" + std::to_string(mat1.size()) + " , mat2:" + std::to_string(mat2.size()));
		std::vector<std::vector<float>> new_mat = std::vector<std::vector<float>>();
	...
	std::vector<std::vector<float>> Matrix::MulCross(std::vector<std::vector<float>> mat1, std::vector<std::vector<float>> mat2) {
		if (mat1.size() != mat2.size()) throw new std::invalid_argument("MulCross: mat1 size is different that mat2 size! mat1:" + std::to_string(mat1.size()) + " , mat2:" + std::to_string(mat2.size()));
		std::vector<std::vector<float>> new_mat = std::vector<std::vector<float>>();
	...
	std::vector<float> Matrix::MulDot(std::vector<std::vector<float>> mat, std::vector<float> vec) {
		...
		for (std::vector<float> i : mat) {
			new_vec.push_back(Vector::MulDot(i, vec));
		}
		return new_vec;
	}
	...
	std::vector<std::vector<float>> Matrix::Div(std::vector<std::vector<float>> mat1, std::vector<std::vector<float>> mat2) {
		if (mat1.size() != mat2.size()) throw new std::invalid_argument("Div: mat1 size is different that mat2 size! mat1:" + std::to_string(mat1.size()) + " , mat2:" + std::to_string(mat2.size()));
		std::vector<std::vector<float>> new_mat = std::vector<std::vector<float>>();
